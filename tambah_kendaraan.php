...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO kendaraan (nama_kendaraan, jenis_kendaraan, plat_nomor, harga_sewa, gambar_kendaraan) 
              VALUES ('$nama_kendaraan', '$jenis_kendaraan', '$plat_nomor', '$harga_sewa', '$gambar_kendaraan')";
...
<body>
    <div class="container mt-5">
        <h1 class="text-center">Tambah Kendaraan</h1>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="gambar_kendaraan" class="form-label">Upload Gambar</label>
                <input type="file" class="form-control" id="gambar_kendaraan" name="gambar_kendaraan" required>
            </div>
