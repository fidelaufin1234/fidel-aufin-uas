...
<head>
    ...
    <title>Dashboard - Sistem Penyewaan Kendaraan</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="fas fa-car"></i> Sistem Penyewaan Kendaraan
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transaksi_penyewaan.php">
    ...
    <div class="container mt-5">
        <h1 class="text-center">Sistem Penyewaan Kendaraan Fidel</h1>
